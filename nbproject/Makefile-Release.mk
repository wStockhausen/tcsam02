...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tcsam02: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tcsam02 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/src/HarvestStrategies.o: src/HarvestStrategies.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/HarvestStrategies.o src/HarvestStrategies.cpp

${OBJECTDIR}/src/IndivData.o: src/IndivData.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/IndivData.o src/IndivData.cpp

${OBJECTDIR}/src/MSEClasses.o: src/MSEClasses.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MSEClasses.o src/MSEClasses.cpp
...
${OBJECTDIR}/src/ModelOptions.o: src/ModelOptions.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ModelOptions.o src/ModelOptions.cpp
...
${OBJECTDIR}/src/ModelPopDyClasses.o: src/ModelPopDyClasses.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ModelPopDyClasses.o src/ModelPopDyClasses.cpp
...
${OBJECTDIR}/src/OFLCalcs.o: src/OFLCalcs.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/OFLCalcs.o src/OFLCalcs.cpp
...
${OBJECTDIR}/tcsam02.o: tcsam02.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tcsam02.o tcsam02.cpp
